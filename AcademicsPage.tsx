      ...
      <div className="bg-white rounded-xl shadow-xl w-full flex flex-col text-gray-800 transition-all duration-300 ease-in-out text-left border border-gray-200/80">
        ...
        <div className="flex-shrink-0 flex items-center justify-between p-3 border-b border-gray-200">
          ...
          <div className="flex items-center space-x-1">
             <button onClick={handleMinimizeToggle} className="p-2 text-gray-500 hover:bg-gray-100 rounded-full transition-colors" title={isMinimized ? "Maximize" : "Minimize"}>
                {isMinimized ? <WindowIcon className="h-5 w-5" /> : <MinusIcon className="h-5 w-5" />}
            </button>
            <button onClick={handleNewChat} className="p-2 text-gray-500 hover:bg-gray-100 rounded-full transition-colors" title="New Chat">
                <ArrowPathIcon className="h-5 w-5" />
            </button>
            <button onClick={handleEndChat} className="p-2 text-red-500 hover:bg-red-50 rounded-full transition-colors" title="End Chat">
