...
const HomePage: React.FC<HomePageProps> = ({ alerts, isLoading, error }) => {
  ...
  const renderAlert = () => {
    if (isLoading) {
      return (
         <div className="bg-white/50 text-left text-gray-700 p-4 rounded-lg shadow-md mb-6">
    ...
    if (error) {
       return (
         <div className="bg-red-100 text-left text-red-800 p-4 rounded-lg shadow-md mb-6">
